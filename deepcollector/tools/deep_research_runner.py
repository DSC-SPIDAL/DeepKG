# =============================================================================
# V24: Deep Research Runner (Configurable Agent Model & Token Bounds)
# =============================================================================
import time
import json
import re
...
class DeepResearchRunner:
    ...
    def _execute_local_research(self, prompt: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            response = self.tools.generate_content_standard("LOCAL", query_prompt, max_new_tokens=planner_limit)
        ...
        try:
            dr_max = getattr(self.config, 'RAG_MAX_NEW_TOKENS', 2048)
            final_response = self.tools.generate_content_standard("LOCAL", extraction_prompt, max_new_tokens=dr_max)
