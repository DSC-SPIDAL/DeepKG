...
# 🔥 FIX: Dynamically checks for EXPORT_FOLDER_ID from environment or Colab secrets
export_id = os.environ.get("EXPORT_FOLDER_ID")
...
config = AppConfig(
    ...
    # 🔥 FIX: Mapped the export variables so the app successfully uploads
    GOOGLE_DRIVE_SHEET_FOLDER_ID = export_id or os.environ.get("DRIVE_SHEET_FOLDER_ID"),
    GOOGLE_DRIVE_LOG_FOLDER_ID = export_id or os.environ.get("DRIVE_LOG_FOLDER_ID"),
